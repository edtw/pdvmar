...
module.exports = {
  ...
  // MongoDB
  MONGODB_URI:
    process.env.MONGODB_URI || "mongodb://localhost:27017/marambaia_pdv",
  ...
  CORS_OPTIONS: {
    origin: function (origin, callback) {
      ...
      const whitelist = [
        ...
        "http://192.168.0.4:3000", // Admin app via IP
        "http://192.168.0.4:3002", // Customer app via IP
        "http://192.168.0.4:3001", // Backend via IP
